...
Then i started writing reports and articles about status of my applied scholarships, fellowships, oppurtunities 
and appretenship,

However this blog itself is the result of that decision.
and i created a structure for that technique.

This technique has a main repository like https://github.com/Gitanuj993 ,
in my case i created an 'activity' directory which includes the following.
